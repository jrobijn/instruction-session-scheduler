...
const nl: Translations = {
  ...
  autoScheduleStudent: 'Automatisch een leerling inplannen',
  autoScheduleLabel: 'Auto-uitnodigen',
  noReplacementFound: 'Er kon geen geschikte vervangende leerling worden gevonden.',
  confirmAddAndInvite: 'Dit stuurt direct een uitnodigingsmail naar de leerling. Doorgaan?',
  confirmAutoInvite: 'Dit selecteert automatisch de eerstvolgende geschikte leerling en stuurt een uitnodigingsmail. Doorgaan?',
