const en = {
  ...
  autoScheduleStudent: 'Automatically schedule a student',
  autoScheduleLabel: 'Auto-invite',
  noReplacementFound: 'No eligible replacement student could be found.',
  confirmAddAndInvite: 'This will immediately send an invitation email to the student. Continue?',
  confirmAutoInvite: 'This will automatically select and invite the next eligible student by email. Continue?',
